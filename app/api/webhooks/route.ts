...
export async function POST(req: NextRequestHint) {
   ...
   if (eventType === "user.created") {
    ...
    const user = {
        ...
        username:
          username ??
          `${first_name ?? "user"}_${last_name ?? Date.now()}`.toLowerCase(),
    ...
    console.log('start connecting to data base ')
...
//   }
  ...
  console.log('this weebhook is done :',evt);
